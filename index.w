...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/wing/wing" class="x-wing" xid="wing"
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="分类设置" xid="classSetBtn" style="width:100%;" onClick="classSetBtnClick">
   <i xid="i1"></i>
   <span xid="span1">分类设置</span></a></div>  
